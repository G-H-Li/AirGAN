...
from src.reference_model.ADAIN_tf import ADAIN_TF


class AdainTrainerTF:
    def __init__(self):
        ...
        dist = 2
        aq = 1
        self.model = ADAIN_TF(met, dist, aq, self.time_window, self.config.dropout)
